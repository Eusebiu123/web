        ...
        <section>
            ...
            <section>
                ...
                <section>
                    ...
                    <p>După autentificare, utilizatorul are acces la pagina principală, ce conține un header cu mai multe opțiuni: Acasă și Despre fac referire la diferite porțiuni ale paginii,
                         Formular Programări trimite la calendarul cu zile disponibile pentru programari, 
                        iar Răspunsuri Programări trimite la un tabel cu programările care au primit răspuns.
                    </p>
                    <section>
                        ...
                        <ul>
                            ...
                            <li>Roșii, dacă ziua este complet indisponibilă, butonul de sub număr fiind neapăsabil. Acest fapt poate proveni dintr-una din următoarele 
                                cauze:
                                <ul>
                                    <li>Ziua deja s-a terminat, caz în care textul din buton va fi "Zi terminată".</li>
                                    <li>Ziua este o sâmbătă sau o duminică, caz în care textul va fi "Week-end".</li>
                                    <li>Toate intervalele din acea zi sunt ocupate. Butonul va avea drept text "Toate rezervate".</li>
                                </ul>
                            </li>
                        </ul>
                        <p>
                            ...
                            butoane verzi, iar cele indisponibile roșii. Formularul conține 6 câmpuri, din care 5 obligatorii:
                        </p>
                        <ul>
                            <li>Câmpul "Data și ora alese" are două input-uri read-only, din care al doilea obligatoriu. Primul arată ziua aleasă, iar al doilea 
                                arată intervalul orar ales prin apăsarea butonului respectiv. Apăsarea unui alt buton verde
                                va determina schimbarea sa cu un interval nou.</li>
    ...
    array_push($errors, "Acest username a fost deja utilizat");
                        ...
                        <ul>
                            ...
                            <li>A doua parte a formularului este alegerea orei și completarea formularului în sine: similar cu alegerea zilei, pentru fiecare oră se 
                                ...
                                folosește metoda POST pentru a trimite datele la apăsarea butonului "Programare".
                            </li>
...
?>
                        ...
                        <p>Pentru administrator, paginile importante rămase sunt administrarea comenzilor primite, a stocurilor și realizarea de comenzi spre furnizori.</p>
                        <ul>
                            <li>Comenzile primite sunt afișate într-un tabel, într-un mod similar cu tabelul de programări trimise. Acesta, la apăsarea unui buton, poate 
                                trimite un răspuns tuturor înregistrărilor în funcție de disponibilitatea pieselor dorite.
                            </li>
                            <li>Stocul service-ului este, în mod similar, afișat într-un tabel care poate fi exportat în format CSV, JSON sau PDF, sau importat dintr-un 
                                fișier CSV sau JSON. În particular, exportarea prin PDF se face folosind librăria FPDF.
                            </li>
                        </ul>
                        <figure typeof="schema:SoftwareSourceCode">
                            <figcaption>Cod pentru exportarea în format CSV:</figcaption>
                            <pre>
                                <code>
if(isset($_POST['eCSV'])){
    ...
    exit();
                        ...
                        <ul>
                            <li>Comenzile spre furnizor se fac printr-un formular în care se introduc datele necesare. Similar cu trimiterea unei programări la service, 
                                datele sunt trimise folosind POST, urmând să fie adăugate automat în baza de date.
                            </li>
                        </ul>
                    </section>
                </section>
                <section>
                    <h4>2.2.3. JavaScript:</h4>
                    <p>JavaScript, în cadrul proiectului, a fost implementat pentru a adăuga un meniu animat la o mare parte din pagini și pentru a implementa AJAX în 
                        cadrul paginilor cu programări răspunse și stoc existent. AJAX are rolul de a permite paginii să se încarce fără elementele de tabel neîncărcate 
                        până la momentul respectiv, acestea fiind adăugate în pagină când se încarcă.
                    </p>
                    <figure typeof="schema:SoftwareSourceCode">
                        <figcaption>Codul JavaScript pentru implementarea AJAX în pagina cu stocul de piese:</figcaption>
                        <pre>
                            <code>
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        <section role="doc-conclusion">
            ...
            <p>În concluzie, această aplicație are rolul de a permite utilizatorilor obișnuiți să poată face programări la service-ul care administrează site-ul, 
                pentru reparații solicitate, alegând și un interval orar convenabil. Administratorii pot răspunde rapid la aceste comenzi, acceptând sau 
                respingându-le motivat, alături de supravegherea stocurilor de produse. Prin urmare, ineracțiunea inutilă este redusă, crescând eficiența service-ului.
            </p>
        </section>
    </article>
</body>
