    ...
    <div class="container">
        ...
        <form method="post" action="register.php">
            ...
            <div class="form-item">
                ...
                <input type="text" name="username"  value="<?php echo $username;?>" id="text" placeholder="username">
            </div>
			<div class="form-item">
                <span class="material-icons-outlined">
                    account_circle
                    </span>
                <input type="text" name="email" value="<?php echo $email;?>" id="text" placeholder="email">
            </div>
